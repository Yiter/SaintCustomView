...
// 颜色
#define SanitColor(r, g, b) [UIColor colorWithRed:(r)/255.0f green:(g)/255.0f blue:(b)/255.0f alpha:1.0f]

// 按钮主题色
#define AppColor [UIColor blackColor]

@interface SaintActionSheet () {
    ...
    /** 代理 */
    id<SaintActionSheetDelegate> _delegate;
}
...
@implementation SaintActionSheet

+ (instancetype)sheetWithTitle:(NSString *)title buttonTitles:(NSArray *)titles redButtonIndex:(NSInteger)buttonIndex delegate:(id<SaintActionSheetDelegate>)delegate {
...
- (instancetype)initWithTitle:(NSString *)title
               ...
               redButtonIndex:(NSInteger)buttonIndex
                     delegate:(id<SaintActionSheetDelegate>)delegate {
    ...
    if (self = [super init]) {
        ...
        [darkView setBackgroundColor:SanitColor(46, 49, 50)];
        ...
        [bottomView setBackgroundColor:SanitColor(233, 233, 238)];
        ...
        if (title) {
            ...
            [label setText:title];
            [label setTextColor:SanitColor(111, 111, 111)];
        ...
        if (titles.count) {
            ...
            NSString *bundlePath = [[NSBundle mainBundle] pathForResource:@"SaintActionSheet" ofType:@"bundle"];
            ...
            for (int i = 0; i < titles.count; i++) {
                ...
                if (i == buttonIndex) {
                    // 红色按钮
                    titleColor = SanitColor(255, 10, 10);
