...
@interface SaintInputView ()<UITextFieldDelegate>
...
- (instancetype)init {
    self = [super init];
    if (self) {
        self = [[[NSBundle mainBundle] loadNibNamed:@"SaintInputView" owner:self options:nil] lastObject];
        // 初始化设置
