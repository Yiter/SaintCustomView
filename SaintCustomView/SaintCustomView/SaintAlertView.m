...
#define DEFAULT_ALERT_WIDTH         [UIScreen mainScreen].bounds.size.width*270/320.0f

#define DEFAULT_ALERT_HEIGHT 144
#define Appcolor         [UIColor orangeColor]    //apperance color


@interface SaintAlertView ()
{
...
- (instancetype)initWithTitle:(NSString *)title message:(NSString *)message cancelButtonTitle:(NSString *)cancelButtonTitle otherButtonTitle:(NSString *)otherButtonTitle
{
    ...
    if (self) {
        ...
        self.appearAnimationType = SaintAlertViewAnimationTypeDefault;
        self.disappearAnimationType = SaintAlertViewAnimationTypeDefault;
        self.cornerRadius = 8;
...
- (void) addThisViewToView: (UIView *) view
{
    ...
    if (self.appearAnimationType == SaintAlertViewAnimationTypeDefault)
    {
    ...
    else if (self.appearAnimationType == SaintAlertViewAnimationTypeZoomIn)
    {
    ...
    else if (self.appearAnimationType == SaintAlertViewAnimationTypeFadeIn)
    {
        self.alpha = 0;
        [UIView animateWithDuration:timeAppear delay:timeDelay options:UIViewAnimationOptionCurveEaseOut animations:^{
            self.alpha = 1;
    ...
    else if (self.appearAnimationType == SaintAlertViewAnimationTypeFlyTop)
    {
    ...
    else if (self.appearAnimationType == SaintAlertViewAnimationTypeFlyBottom)
    {
        CGRect tmpFrame = self.frame;
    ...
    else if (self.appearAnimationType == SaintAlertViewAnimationTypeFlyLeft)
    {
        CGRect tmpFrame = self.frame;
    ...
    else if (self.appearAnimationType == SaintAlertViewAnimationTypeFlyRight)
    {
        CGRect tmpFrame = self.frame;
    ...
    else if (self.appearAnimationType == SaintAlertViewAnimationTypeNone)
    {
        [self didAppearAlertView];
    }
}
...
- (void)dismiss
{
    ...
    if (self.disappearAnimationType == SaintAlertViewAnimationTypeDefault) {
        self.transform = CGAffineTransformIdentity;
    ...
    else if (self.disappearAnimationType == SaintAlertViewAnimationTypeZoomOut )
    {
        self.transform = CGAffineTransformIdentity;
        [UIView animateWithDuration:timeDisappear delay:timeDelay options:UIViewAnimationOptionCurveEaseOut animations:^{
            self.transform = CGAffineTransformMakeScale(0.01, 0.01);
    ...
    else if (self.disappearAnimationType == SaintAlertViewAnimationTypeFaceOut)
    {
        self.alpha = 1;
        [UIView animateWithDuration:timeDisappear delay:timeDelay options:UIViewAnimationOptionCurveEaseOut animations:^{
            self.alpha = 0;
    ...
    else if (self.disappearAnimationType == SaintAlertViewAnimationTypeFlyTop)
    {
        [UIView animateWithDuration:timeDisappear delay:timeDelay options:UIViewAnimationOptionCurveEaseOut animations:^{
            self.frame = CGRectMake(self.frame.origin.x, - self.frame.size.height - 10, self.frame.size.width, self.frame.size.height);
    ...
    else if (self.disappearAnimationType == SaintAlertViewAnimationTypeFlyBottom)
    {
        [UIView animateWithDuration:timeDisappear delay:timeDelay options:UIViewAnimationOptionCurveEaseOut animations:^{
    ...
    else if (self.disappearAnimationType == SaintAlertViewAnimationTypeFlyLeft)
    {
        [UIView animateWithDuration:timeDisappear delay:timeDelay options:UIViewAnimationOptionCurveEaseOut animations:^{
            self.frame = CGRectMake( - self.frame.size.width - 10, self.frame.origin.y, self.frame.size.width, self.frame.size.height);
    ...
    else if (self.disappearAnimationType == SaintAlertViewAnimationTypeFlyRight)
    {
        [UIView animateWithDuration:timeDisappear delay:timeDelay options:UIViewAnimationOptionCurveEaseOut animations:^{
    ...
    else if (self.disappearAnimationType == SaintAlertViewAnimationTypeNone)
    {
        [self removeFromSuperview];
    }
...
- (void)setupItems
{
    ...
    [self.cancelButton setTitleColor:Appcolor forState:UIControlStateNormal];
    ...
    [self.otherButton setTitleColor:Appcolor forState:UIControlStateNormal];
